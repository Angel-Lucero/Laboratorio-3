...
begin
    ...
    values(p_Nombre, p_Apellidos, p_Telefono, p_Email, p_Direccion);
end $$
delimiter ;
...
call sp_AgregarCategoria('Laptops', 'Computadoras portátiles de diferentes marcas y especificaciones', 'Dispositivo', 1);
call sp_AgregarCategoria('Procesadores', 'Unidades centrales de procesamiento para computadoras', 'Componente', 2);
call sp_AgregarCategoria('Teclados', 'Dispositivos de entrada para computadoras', 'Periférico', 3);
call sp_AgregarCategoria('Mouse', 'Dispositivos apuntadores para computadoras', 'Periférico', 3);
call sp_AgregarCategoria('Monitores', 'Pantallas para visualización de contenido', 'Dispositivo', 1);
call sp_AgregarCategoria('Memorias RAM', 'Memoria de acceso aleatorio para computadoras', 'Componente', 2);
call sp_AgregarCategoria('Discos Duros', 'Dispositivos de almacenamiento de datos', 'Componente', 2);
call sp_AgregarCategoria('Tarjetas Gráficas', 'Procesadores dedicados para gráficos', 'Componente', 2);
call sp_AgregarCategoria('Impresoras', 'Dispositivos para imprimir documentos', 'Dispositivo', 1);
call sp_AgregarCategoria('Audífonos', 'Dispositivos de audio personal', 'Accesorio', 4);
...
call sp_AgregarProducto('Laptop EliteBook', 'Laptop empresarial de alto rendimiento', 'HP', 'EliteBook 840 G7', 25000.00, 5, 1, 24, 'Plata', 1.45, '32.4 x 21.8 x 1.79 cm', 'https://ejemplo.com/laptop1.jpg');
call sp_AgregarProducto('Procesador Core i7', 'Procesador de 10ma generación', 'Intel', 'i7-10700K', 6500.00, 10, 2, 36, NULL, 0.05, '37.5 x 37.5 mm', 'https://ejemplo.com/procesador1.jpg');
call sp_AgregarProducto('Teclado mecánico', 'Teclado mecánico para gaming', 'Logitech', 'G Pro X', 2200.00, 8, 3, 12, 'Negro', 0.98, '44 x 15 x 3.3 cm', 'https://ejemplo.com/teclado1.jpg');
call sp_AgregarProducto('Mouse inalámbrico', 'Mouse ergonómico inalámbrico', 'Microsoft', 'Sculpt Ergonomic', 1200.00, 15, 4, 12, 'Negro', 0.15, '12 x 7 x 4 cm', 'https://ejemplo.com/mouse1.jpg');
call sp_AgregarProducto('Monitor 27" 4K', 'Monitor UHD con HDR', 'Dell', 'UltraSharp U2720Q', 12000.00, 6, 5, 24, 'Negro', 5.8, '61.1 x 36.4 x 21.6 cm', 'https://ejemplo.com/monitor1.jpg');
call sp_AgregarProducto('Memoria DDR4 16GB', 'Memoria RAM de alta velocidad', 'Corsair', 'Vengeance LPX', 1800.00, 20, 6, 24, 'Negro', 0.03, '13.3 x 3.4 x 0.5 cm', 'https://ejemplo.com/ram1.jpg');
call sp_AgregarProducto('SSD 1TB NVMe', 'Disco de estado sólido ultrarrápido', 'Samsung', '970 EVO Plus', 3500.00, 12, 7, 60, NULL, 0.01, '8 x 2.2 x 0.2 cm', 'https://ejemplo.com/ssd1.jpg');
call sp_AgregarProducto('Tarjeta Gráfica RTX 3080', 'Tarjeta gráfica para gaming', 'NVIDIA', 'RTX 3080 Founders', 25000.00, 4, 8, 36, 'Negro/Plateado', 1.4, '28.5 x 11.2 x 5.1 cm', 'https://ejemplo.com/gpu1.jpg');
call sp_AgregarProducto('Impresora multifuncional', 'Impresora láser a color', 'Brother', 'MFC-L3750CDW', 8500.00, 7, 9, 12, 'Blanco', 28.5, '42 x 39.8 x 42.6 cm', 'https://ejemplo.com/impresora1.jpg');
call sp_AgregarProducto('Audífonos inalámbricos', 'Audífonos con cancelación de ruido', 'Sony', 'WH-1000XM4', 7000.00, 9, 10, 12, 'Negro', 0.25, '18.5 x 16.8 x 6.9 cm', 'https://ejemplo.com/audifonos1.jpg');

call sp_AgregarEspecificacion(1, 'Procesador', 'Intel Core i7-1165G7', NULL);
call sp_AgregarEspecificacion(1, 'RAM', '16GB', 'DDR4');
call sp_AgregarEspecificacion(2, 'Núcleos', '8', NULL);
call sp_AgregarEspecificacion(2, 'Frecuencia base', '3.8', 'GHz');
call sp_AgregarEspecificacion(3, 'Tipo de switches', 'GX Blue Clicky', NULL);
call sp_AgregarEspecificacion(3, 'Retroiluminación', 'RGB', NULL);
call sp_AgregarEspecificacion(4, 'DPI máximo', '4000', NULL);
call sp_AgregarEspecificacion(4, 'Conectividad', 'Bluetooth + USB', NULL);
call sp_AgregarEspecificacion(5, 'Tasa de refresco', '60', 'Hz');
call sp_AgregarEspecificacion(5, 'Tipo de panel', 'IPS', NULL);

call sp_AgregarProductoProveedor(1, 1, 'HP-ELITE-001', 21000.00, 5);
call sp_AgregarProductoProveedor(2, 2, 'INT-I7-10700K', 5800.00, 3);
call sp_AgregarProductoProveedor(3, 3, 'LOG-GPROX', 1800.00, 7);
call sp_AgregarProductoProveedor(4, 4, 'MS-SCULPT', 950.00, 10);
call sp_AgregarProductoProveedor(5, 5, 'DELL-U2720Q', 10000.00, 15);
call sp_AgregarProductoProveedor(6, 6, 'COR-VLPX16', 1500.00, 2);
call sp_AgregarProductoProveedor(7, 7, 'SAM-970EVO1T', 2900.00, 4);
call sp_AgregarProductoProveedor(8, 8, 'NV-RTX3080FE', 22000.00, 30);
call sp_AgregarProductoProveedor(9, 9, 'BR-MFCL3750', 7000.00, 8);
call sp_AgregarProductoProveedor(10, 10, 'SON-WH1000XM4', 5800.00, 12);

call sp_AgregarCliente('Juan', 'Pérez García', '5551112233', 'juan.perez@email.com', 'Calle Primavera 123, CDMX');
call sp_AgregarCliente('María', 'López Martínez', '5552223344', 'maria.lopez@email.com', 'Av. Reforma 456, Guadalajara');
call sp_AgregarCliente('Carlos', 'González Hernández', '5553334455', 'carlos.gonzalez@email.com', 'Blvd. Universidad 789, Monterrey');
call sp_AgregarCliente('Ana', 'Rodríguez Sánchez', '5554445566', 'ana.rodriguez@email.com', 'Calle Roble 1011, Puebla');
call sp_AgregarCliente('Luis', 'Martínez Díaz', '5555556677', 'luis.martinez@email.com', 'Av. Tecnológico 1213, Tijuana');
call sp_AgregarCliente('Laura', 'Hernández Ruiz', '5556667788', 'laura.hernandez@email.com', 'Calle Nogal 1415, Querétaro');
call sp_AgregarCliente('Pedro', 'Sánchez Flores', '5557778899', 'pedro.sanchez@email.com', 'Av. Industrial 1617, León');
call sp_AgregarCliente('Sofía', 'Díaz Castro', '5558889900', 'sofia.diaz@email.com', 'Blvd. Las Américas 1819, Mérida');
call sp_AgregarCliente('Jorge', 'Flores Romero', '5559990011', 'jorge.flores@email.com', 'Calle Caribe 2021, Cancún');
call sp_AgregarCliente('Patricia', 'Castro Mendoza', '5550001122', 'patricia.castro@email.com', 'Av. Toluca 2223, Toluca');

call sp_AgregarVenta(1, 25000.00, 4000.00, 29000.00, 'Tarjeta', 1, 'Facturada', 'FAC-00001', @ventaId);
call sp_AgregarVenta(2, 6500.00, 1040.00, 7540.00, 'Transferencia', 2, 'Facturada', 'FAC-00002', @ventaId);
call sp_AgregarVenta(3, 2200.00, 352.00, 2552.00, 'Efectivo', 3, 'No Facturada', NULL, @ventaId);
call sp_AgregarVenta(4, 1200.00, 192.00, 1392.00, 'Tarjeta', 4, 'Facturada', 'FAC-00003', @ventaId);
call sp_AgregarVenta(5, 12000.00, 1920.00, 13920.00, 'Meses sin intereses', 5, 'Facturada', 'FAC-00004', @ventaId);
call sp_AgregarVenta(6, 1800.00, 288.00, 2088.00, 'Transferencia', 6, 'No Facturada', NULL, @ventaId);
call sp_AgregarVenta(7, 3500.00, 560.00, 4060.00, 'Tarjeta', 7, 'Facturada', 'FAC-00005', @ventaId);
call sp_AgregarVenta(8, 25000.00, 4000.00, 29000.00, 'Meses sin intereses', 8, 'Facturada', 'FAC-00006', @ventaId);
call sp_AgregarVenta(9, 8500.00, 1360.00, 9860.00, 'Transferencia', 9, 'Facturada', 'FAC-00007', @ventaId);
call sp_AgregarVenta(10, 7000.00, 1120.00, 8120.00, 'Efectivo', 10, 'No Facturada', NULL, @ventaId);
...
call sp_AgregarMovimientoInventario(1, 'Entrada', 10, NULL, 1, 'Compra inicial de inventario');
call sp_AgregarMovimientoInventario(2, 'Entrada', 20, NULL, 2, 'Compra inicial de inventario');
call sp_AgregarMovimientoInventario(3, 'Entrada', 15, NULL, 3, 'Compra inicial de inventario');
call sp_AgregarMovimientoInventario(4, 'Entrada', 30, NULL, 4, 'Compra inicial de inventario');
call sp_AgregarMovimientoInventario(5, 'Entrada', 8, NULL, 5, 'Compra inicial de inventario');
call sp_AgregarMovimientoInventario(6, 'Entrada', 50, NULL, 6, 'Compra inicial de inventario');
call sp_AgregarMovimientoInventario(7, 'Entrada', 25, NULL, 7, 'Compra inicial de inventario');
call sp_AgregarMovimientoInventario(8, 'Entrada', 5, NULL, 8, 'Compra inicial de inventario');
call sp_AgregarMovimientoInventario(9, 'Entrada', 10, NULL, 9, 'Compra inicial de inventario');
call sp_AgregarMovimientoInventario(10, 'Entrada', 15, NULL, 10, 'Compra inicial de inventario');

call sp_AgregarMovimientoInventario(1, 'Salida', 1, 1, NULL, 'Venta al cliente Juan Pérez');
call sp_AgregarMovimientoInventario(2, 'Salida', 1, 2, NULL, 'Venta al cliente María López');
call sp_AgregarMovimientoInventario(3, 'Salida', 1, 3, NULL, 'Venta al cliente Carlos González');
call sp_AgregarMovimientoInventario(4, 'Salida', 1, 4, NULL, 'Venta al cliente Ana Rodríguez');
call sp_AgregarMovimientoInventario(5, 'Salida', 1, 5, NULL, 'Venta al cliente Luis Martínez');
call sp_AgregarMovimientoInventario(6, 'Salida', 2, 6, NULL, 'Venta al cliente Laura Hernández');
call sp_AgregarMovimientoInventario(7, 'Salida', 1, 7, NULL, 'Venta al cliente Pedro Sánchez');
call sp_AgregarMovimientoInventario(8, 'Salida', 1, 8, NULL, 'Venta al cliente Sofía Díaz');
call sp_AgregarMovimientoInventario(9, 'Salida', 1, 9, NULL, 'Venta al cliente Jorge Flores');
call sp_AgregarMovimientoInventario(10, 'Salida', 1, 10, NULL, 'Venta al cliente Patricia Castro');